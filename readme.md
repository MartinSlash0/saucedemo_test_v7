                              ...
                              - Pytest                    - Page Object Model (POM)
                                              ...
                                              │
                                              ├── tests/
                                              │ ├── test_1_login_negative.py
                                              │ ├── test_2_login_flow.py
                                              │ ├── test_3_logout_flow.py
                                              │ ├── test_4_cart_functionality.py
                                              │ ├── test_5_checkout_flow.py
                                              │
                                              ├── locators.py
                                              ├── config.py
                                              ├── conftest.py
                              ...
                              - Logout flow
                              = Logout verification using UI elements
